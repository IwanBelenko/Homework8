...
Console.WriteLine($"{minSumLine+1} - row with the smallest sum ({sumLine}) of elements ");
...
int range = InputNumbers("Input range of random numbers: from 1 to ");
...
Console.WriteLine("product of first and second matrix:");
...
Console.WriteLine("Input size of array X x Y x Z:");
